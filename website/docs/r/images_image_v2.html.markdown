...
page_title: "HuaweiCloudStack: huaweicloudstack_images_image_v2"
sidebar_current: "docs-huaweicloudstack-resource-images-image-v2"
description: |-
  Manages a V2 Image resource within HuaweiCloudStack IMS.
---

# huaweicloudstack\_images\_image_v2
...
```hcl
resource "huaweicloudstack_images_image_v2" "rancheros" {
  name             = "RancherOS"
...
* `disk_format` - (Required) The disk format. Must be one of "qcow2", "vhd", "raw", "zvhd".
...
* `owner` - The id of the huaweicloudstack user who owns the image.
...
```
$ terraform import huaweicloudstack_images_image_v2.rancheros 89c60255-9bd6-460c-822a-e2b959ede9d2
```
